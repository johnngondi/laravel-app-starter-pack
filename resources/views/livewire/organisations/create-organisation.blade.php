<div class="flex flex-col gap-6">
    <div class="text-center">
        ...
        <flux:subheading>
            {{ __('Every debtor, debt and payment in Wegon AI belongs to an organisation. Set yours up to get started.') }}
        </flux:subheading>
    </div>
    ...
    <form wire:submit="submit" class="flex flex-col gap-6 rounded-xl border border-neutral-200 p-6 dark:border-neutral-700">
        ...
        <div @class(['grid grid-cols-1 gap-4 sm:grid-cols-2', 'hidden' => $step !== 1])>
            ...
            <x-input wire:model="name" type="text" :placeholder="__('e.g. Wegon Collections Ltd')">
