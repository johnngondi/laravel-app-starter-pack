<section class="w-full">
    ...
    <x-settings.user-layout :heading="__('Update password')" :subheading="__('Ensure your account is using a long, random password to stay secure')">
        <form method="POST" wire:submit="updatePassword" class="mt-6 space-y-6">
            ...
            >
                <x-slot:label><x-required-label>{{ __('Current password') }}</x-required-label></x-slot:label>
            </x-password>
            <x-password
                wire:model="password"
                required
            ...
            >
                <x-slot:label><x-required-label>{{ __('New password') }}</x-required-label></x-slot:label>
            </x-password>
            <x-password
            ...
            <div class="flex items-center gap-4">
                <x-button primary type="submit" spinner="updatePassword" data-test="update-password-button">{{ __('Save') }}</x-button>
            </div>
        </form>
